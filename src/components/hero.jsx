...
function Hero (){
    return(
        <>
        <section  className="bg-[url('/bg.svg')]   animate-fadeIn bg-no-repeat bg-[red]   bg-cover pt-[200px] md:pt-[220px] sm:pt-[230px]  xl:pl-[72px] md:pl-[40px] pl-[30px] w-full h-[90vh]  ">
