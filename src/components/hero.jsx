...
function Hero (){
    return(
        <>
        <section  className="bg-[url('./src/svg/hero/bg.svg')]  animate-fadeIn  animate-pulse transform  bg-cover pt-[200px] md:pt-[220px] sm:pt-[230px] bg-center xl:pl-[72px] md:pl-[40px] pl-[30px] w-full h-[90vh]  ">
            <div className=" w-[542px] h-[442px]">
                ...
                <h3 className="font-karan xl:w-[491px] w-[300px] md:h-[45px] sm:h-[49px] h-[45px] text-[22px] sm:text-[28px]  text-[#977656] mt-[24px]">
                EXPERT HAIRCUTS AND GROOMING SERVICES
                </h3>
                <p className="xl:w-[342px]  sm:w-[300px] w-[200px] xl:h-[150px] sm:h-[100px] h-[120px] opacity-[64%] font-inter text-[16px] text-[#fbeadb]">
