    ...
    return(
        ...
        <section>
            <div className="w-full h-[515px] bg-[#FFFFFF] flex  flex-col items-center pt-[60px]  ">
                ...
                <div className="w-[1296px] h-[183px] flex justify-center items-center xl:gap-[75px] lg:gap-[10px] md:gap-[20px] sm:gap-[30px] pl-[20px] sm:pl-0 border-b border-[#E9C664] ">
